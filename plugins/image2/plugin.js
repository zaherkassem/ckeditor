...
(function () {
        ...
        return {
            ...
            data: function () {
                ...
                this.parts.image.setAttributes({
                    ...
                    'data-cke-saved-src': srcWithScale,
    ...
    function setupResizer(widget) {
        ...
        if (!widget.inline) {
            ...
            widget.wrapper.append(pixelIndicator);
        ...
        resizer.on('mousedown', function (evt) {
            ...
            // A class applied to editable during resizing.
                ...
                nativeEvt, newWidth, newHeight, updateData = false,
            ...
            function onMouseMove(evt) {
                ...
                // Don't update attributes if less than 75.
